...
const transporter = nodeMailer.createTransport({
    ...
    secure: true,
    auth: {
        user: "docai394@gmail.com",
        pass: "jfuxspbzqaurhpcp"
    }
})
    ...
    try {
        let info = await transporter.sendMail({
            ...
            <div style="margin:50px auto;width:70%;padding:20px 0">
                ...
                <p>Hello A2SVian! please use the otp number below to ${credentials.proc} procedure. <strong> ${credentials.extra} </strong></p>
